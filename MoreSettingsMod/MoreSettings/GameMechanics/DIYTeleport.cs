...
namespace MoreSettings.GameMechanics
{
    public class DIYFlashTeleport : GameCinematic
    {
        ...
        public DIYFlashTeleport(Hero owen, Teleport from, Entity entity)
        {
            ...
            SettingsMain.ConfigValue.UI.PlayerCameraSpeed = Main.Class.ME.options.playerCameraSpeed;
        ...
        public void move()
        {
            ...
            Main.Class.ME.options.playerCameraSpeed = SettingsMain.ConfigValue.UI.PlayerCameraSpeed;
